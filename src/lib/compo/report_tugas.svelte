<script>
  ...
  const upload_file_report = async () => {
    ...
    var newFile = new File(
      [blob],
      tugas.id_tugas.toString() + "_tugas_" + file.name,
      { type: file.type }
    );
...
>
  ...
  >
    <div class="flex flex-col items-center w-full justify-center">
      ...
      >
        {#if status_report == 3}upload report{:else}lihat peogres dan report{/if}
      </h4>
      ...
      {:else if access_user == 2}
        ...
        {:else if status_report == 4}
          <!-- aksi setelah report -->
          <h3 class=" text-center mb-3">
            Staff telah mengunggah file report , silahkan review dari Manager
          </h3>
          <button
            on:click={() => {
              download_file_report();
          ...
          <div class=" flex w-full p-2 mt-3 flex-col">
            ...
            <input
              ...
              max="100"
              min="0"
              bind:value={tugas.progres}
              class="my-2"
            />
            <button
              on:click={() => {
                update_capaian("progres", tugas.progres);
              }}
        ...
        {:else if status_report == 5}
          <h3>
            Staff sedang merevisi pekerjaan, silahkan tunggu staff menyelesaikan
            tugas
          </h3>
        {:else if status_report == 6}
          <h3>tugas telah selesai dan mencapai target</h3>
      ...
      {:else if access_user == 3 || access_user == 4}
        ...
        {:else if status_report == 6}
          ...
          <button
            ...
            class=" w-60 h-10 mt-3 bg-cyan-400 rounded-lg flex justify-around text-base items-center"
          >
            <h5 class=" border-r border-white px-5">download file</h5>
            <DownloadFile ukuran="w-8 h-8"></DownloadFile></button
          >
