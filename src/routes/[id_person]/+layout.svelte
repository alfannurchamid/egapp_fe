...
<div
  class="fixed z-20 top-0 flex w-full p-2 px-6 text-gray-800 bg-white drop-shadow"
>
...
<div class="fixed z-20 top-16 flex w-full p-1 px-11 bg-white drop-shadow">
  <Breadcrumb />
</div>
...
<!-- <div class="w-full mt-20 flex justify-between items-center flex-row">
  <Breadcrumb />
</div> -->
