...
<div class="  flex flex-col items-center justify-center p-5 bg-gray-100">
  ...
  <div class="w-full h-16 flex justify-center items-center">
    ...
    <div class=" w-20 h-1 bg-slate-200"></div>
  ...
  <!-- step 1 -->
  <div
    class=" p-5 text-gray-700 flex container rounded-lg drop-shadow-lg justify-center flex-col items-center bg-white"
  >
    ...
    <form action="" class=" w-full">
      <div class="w-full flex flex-col my-1">
        ...
        <input
          id="nik"
          placeholder="Contoh: 3307011203000000"
          ...
          type="text"
        />
        <p id="alert_nik" class="text-xs text-red-400 hidden">
          NIK harus diisi
        </p>
      </div>
      <div class="w-full flex flex-col my-1">
        ...
        <input
          ...
          bind:value={Sandi}
          placeholder="tulis dengan huruf kecil"
          id="inpSandi"
          class=" inpSandi placeholder:text-gray-300 px-3 placeholder:text-sm my-1 h-9 rounded-lg border border-collapse border-gray-300 focus:border-gray-700"
          type="text"
        />
      </div>
      <input
        type="submit"
        id="TbMasuk"
        class=" mt-8 cursor-default TbPasif w-full h-10 rounded-lg items-center flex justify-center font-semibold"
        value="lanjutkan"
      />
    </form>
  </div>
  ...
  >
    ...
    <p>
      Hubungi <a
        ...
        href="https://wa.me/+6282138917616"
      >
        'mba kari' melalui whatsapp</a
      > untuk meminta kode OTP
    </p>
    <form action="" class=" w-full">
    ...
    <form action="" class=" w-full">
      <div class="w-full flex flex-col my-1">
        ...
        <button
          ...
          class="text-xs self-end mr-3">tampilkan sandi</button
        >
        <input
          type="submit"
          id="TbMasuk"
